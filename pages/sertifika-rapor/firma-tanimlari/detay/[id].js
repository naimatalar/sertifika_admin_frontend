                    ...
                    <div className='card p-5'>
                        <div className='row'>
                            ...
                            <div className='col-12 col-md-8 mt-md-0 mt-5'>
                                <button className='btn btn-success btn-sm mb-2' onClick={() => { setModelOpen(true); setDocumnetType(2); setInitialData({ id: null }); setDocumentFiles([]) }}><i className='fa fa-plus'></i> Yeni Rapor Ekle</button>

                                {refreshPAge && <> <table className='table table-hovered mb-3'>
                                    <thead>
                                        <tr>
                                            <th>
                                                Adı
                                    ...
                                    <button className='btn btn-success btn-sm mb-2 mt-5' onClick={() => { setModelOpen(true); setDocumnetType(1); setInitialData({ id: null }); setDocumentFiles([]) }}><i className='fa fa-plus'></i> Yeni Sertifika Ekle</button>
